...
## [Unreleased]
## [0.10.0-alpha.2](https://github.com/Rust-GPU/rust-gpu/compare/v0.10.0-alpha.1...v0.10.0-alpha.2) - 2026-05-04
...
- [PR#959](https://github.com/EmbarkStudios/rust-gpu/pull/959) added two `spirv-builder` environment variables to customize _only_ the `rustc` invocations for shader crates and their dependencies:
